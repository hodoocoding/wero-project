...
const TextReveal: React.FC<TextBlockProps> = ({
  title,
  kor,
  eng,
  isMain = false,
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full transition-all duration-500">
        {/* Korean Text (Default) - Relative to hold height */}
        <div
        ...
        >
          <p
            className={`${
              isMain
                ? "text-2xl md:text-4xl font-bold leading-relaxed break-keep"
                : "text-lg text-gray-300 leading-relaxed break-keep"
            }`}
          >
            {kor.split("\n").map((line, i) => (
        ...
        {/* English Text (Hover) - Absolute Overlay */}
        <div
        ...
        >
          <p
            className={`${
              isMain
                ? "text-2xl md:text-4xl font-display font-bold leading-relaxed text-white"
                : "text-lg text-brand-accent font-medium leading-relaxed"
            }`}
          >
            {eng.split("\n").map((line, i) => (
              <span key={i} className="block">
    ...
    <section id="about" className="py-32 bg-brand-black relative">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-5xl mb-32">
          {/* Changed isMain to false (or removed) to match Vision body size as requested */}
          <TextReveal
            title="WHO WE ARE"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 border-t border-white/10 pt-16">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <div className="mb-6 text-2xl md:text-3xl font-display font-bold text-white uppercase tracking-widest">
        ...
        <div className="mt-32">
          {/* Left Align Title */}
          <h3 className="text-brand-accent font-bold tracking-widest uppercase mb-12 text-sm text-left">
            CORE VALUES
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-brand-dark p-8 border border-white/5 hover:border-brand-accent/50 transition-colors group">
              <h4 className="text-3xl font-display font-bold mb-4 group-hover:text-brand-accent transition-colors">
                BOLD
              </h4>
              <p className="text-gray-300 text-lg leading-relaxed mb-4">
                결단력 있게 판단하고, 책임 있게 실행합니다.
              </p>
              <p className="text-gray-500 text-sm md:text-base leading-relaxed group-hover:text-white transition-colors">
